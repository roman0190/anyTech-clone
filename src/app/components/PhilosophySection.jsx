...
export const PhilosophySection = () => {
  ...
  return (
    ...
    <div className="flex flex-col items-center gap-6 font-sans">
      <h6 className="text-blue-500 font-bold text-[18px] font-sans">
        OUR PHILOSOPHY
      </h6>
      ...
      <figure className="w-full h-full">
        ...
        <Image
          ...
          width={1080}
          height={1080}
          className="md:hidden lg:hidden w-full h-full object-cover"
        />
      </figure>
    </div>
    <div className="mt-10">
      ...
      <ul className="hidden md:flex justify-between gap-10">
        {list.map((item) => (
          ...
          >
            ...
            />
            <h4 className="text-[28px] font-bold font-sans">Full-suite solutions</h4>
            <p className="text-[16px] font-sans font-medium text-blue-900">
              Experience the ease of integration across various banking and payment
